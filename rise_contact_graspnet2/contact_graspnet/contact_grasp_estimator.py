...
BASE_DIR = "/home/ros_ws/src/rise_contact_graspnet2"
# sys.path.append(os.path.join(BASE_DIR))
sys.path.append(os.path.join(BASE_DIR, 'pointnet2',  'utils'))
BASE_DIR = "/home/ros_ws/src/rise_contact_graspnet2/contact_graspnet"
...
class GraspEstimator:
    ...
    def __init__(self, cfg):
        ...
        import contact_graspnet.contact_graspnet as _model
        self._model_func =_model
